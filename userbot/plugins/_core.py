...
async def unload(event):
    ...
    try:
        ...
        qwe = await eor(event, f"HUNTERBOT Has Successfully unloaded {shortname}")
    except Exception as e:
        await qwe.edit(
            "HUNTERBOT has Successfully unloaded {shortname}\n{}".format(shortname, str(e))
        )
...
async def load(event):
    ...
    try:
        ...
        await qwe.edit(
            f"HUNTERBOT could not load {shortname} because of the following error.\n{str(e)}"
        )
